...
const UserGroupSchema := tfsdk.Schema{
	...
	Attributes: map[string]tfsdk.Attribute{
		...
		"properties": {
			...
			Attributes: tfsdk.ListNestedAttributes(map[strng]tfsdk.Attribute{
				"name": {
		...
		"member-query-filters": {
			...
			Attributes: tfsdk.ListNestedAttributes(map[string]tfsdk.Attribute{
				"query": {
					Required: true,
					Attribute: tfsdk.MapNestedAttributes(map[string]tfsdk.Attribute{
						"field": {
